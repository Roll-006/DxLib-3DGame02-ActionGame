...
static struct UIGraphicPath
{
	...
	const std::string MELEE_EXPLANATORY_TEXT_BOX_BLUR	= "Data/Graphic/UI/Melee/explanatory_text_box_blur.png";
	#pragma endregion


	#pragma region ステルスキル
	const std::string STEALTH_KILL_CIRCLE_BLUR			= "Data/Graphic/UI/StealthKill/circle_blur.png";
	#pragma endregion
