...
namespace v2d
{
	[[nodiscard]] inline float GetSize(const v2d_concepts::ValidT auto& v) { return static_cast<float>(sqrt(v.x * v.x + v.y * v.y)); }

	[[nodiscard]] inline float GetSquareSize(const v2d_concepts::ValidT auto& v) { return v.x * v.x + v.y * v.y; }

	template<v2d_concepts::ValidT VecT>
	[[nodiscard]] inline VecT GetZeroV() { return { 0, 0 }; }
...
template<v2d_concepts::ValidT VecT>
inline void from_json(const nlohmann::json& j_data, VecT& vector)
{
...
template<v2d_concepts::ValidT VecT>
inline void to_json(nlohmann::json& j_data, const VecT& vector)
{
