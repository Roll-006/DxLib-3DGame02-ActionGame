	...
	m_result_screen		(nullptr)
{
	...
	{
		game_over_text_data = data.at("text_data").at("game_over").get<GameOverTextData>();
		...
		game_over_text_data.text_data.u_int_color	= color_converter::ConvertHEXToUINT(game_over_text_data.text_data.hex_color);
