...
{
	class FirstSideSlashKnife final : public WeaponActionStateBase
	{
	public:
		FirstSideSlashKnife(Player& player);
	...
	private:
		static constexpr float kComboValidTime = 0.7f;	// 二段階目の攻撃が有効になる時間
