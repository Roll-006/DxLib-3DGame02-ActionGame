#include "boss_action_null.hpp"

boss_state::ActionNull::ActionNull() :
	ActionStateBase		(static_cast<int>(boss_state::ActionStateKind::kActionNull)),
...
void boss_state::ActionNull::Update(std::shared_ptr<Boss>& obj)
{
	if (obj->CanAction())
	{
...
void boss_state::ActionNull::LateUpdate(std::shared_ptr<Boss>& obj)
{

}

void boss_state::ActionNull::Enter(std::shared_ptr<Boss>& obj)
{

}

void boss_state::ActionNull::Exit(std::shared_ptr<Boss>& obj)
{

}

std::shared_ptr<IState<Boss>> boss_state::ActionNull::ChangeState(std::shared_ptr<Boss>& obj)
{
