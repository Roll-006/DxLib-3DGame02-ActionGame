...
struct WarningTabData
{
	...
	std::string				warning_graphic_icon_path	= "";
...
inline void from_json(const nlohmann::json& j_data, WarningTabData& warning_tab_data)
{
	...
	j_data.at("explanatory_text_data")			.get_to(warning_tab_data.explanatory_text_data);
	j_data.at("text_data")						.get_to(warning_tab_data.text_data);
	...
	j_data.at("warning_graphic_icon_path")		.get_to(warning_tab_data.warning_graphic_icon_path);
	j_data.at("button_prompt_name")				.get_to(warning_tab_data.button_prompt_name);
}
...
inline void to_json(nlohmann::json& j_data, const WarningTabData& warning_tab_data)
{
	j_data = nlohmann::json
	{
		...
		{ "explanatory_text_data",			warning_tab_data.explanatory_text_data },
		{ "text_data",						warning_tab_data.text_data },
		...
		{ "warning_graphic_icon_path",		warning_tab_data.warning_graphic_icon_path },
		{ "button_prompt_name",				warning_tab_data.button_prompt_name },
	};
}
#pragma endregion
